...
# ==========================
#  Decorator customizado para Admins
# ==========================

def career_admins_only(f):
    """Decorator compatível com CTFd >= 3.8 (evita falha de contexto dos plugins)."""
    @wraps(f)
...
def register_routes(blueprint):
    ...
    def create_career():
        ...
        return jsonify({"success": True, "data": career.to_dict()}), HTTPStatus.CREATED
    ...
    def create_step():
        ...
        return jsonify({"success": True, "data": step.to_dict()}), HTTPStatus.CREATED
