...
template_vmid = int(env("TEMPLATE_VMID", "2203"))
...
# --- Saída para UI ---
# Para a UI: mensagem amigável
print(f"O IP da sua instância é: {ip}")

# Obs.: o arquivo outputs.json mantém {"vmid","ip"} para o destroy.py usar.
# Se você quiser rodar smoke/debug local e ver o JSON completo, basta trocar a linha acima por:
# print(json.dumps(out))
